export const resumeData = {
  personalInfo: {
    ...
    title: "Frontend Developer (Angular, Next.js & React.js)",
    phone: "+91 83499 45280",
    email: "niteshkushwaha603@gmail.com",
    linkedin: "LinkedIn", // Replace with actual link later
    github: "GitHub",   // Replace with actual link later
    summary: "Results-driven Frontend Developer with 2+ years of experience specializing in Angular, Next.js, and React.js. Proven track record of improving application performance by 133% through Server-Side Rendering (SSR) optimization. Expert in building complex reactive forms, implementing role-based access control (RBAC) systems, and creating reusable component libraries that reduce development time by 25-30%. Passionate about delivering high-performance, scalable web applications with exceptional user experiences."
  },
  skills: {
    frameworks: ["Angular (14+)", "Next.js 13/14", "React.js 17"],
    languages: ["TypeScript", "JavaScript (ES6+)", "HTML5", "CSS3"],
    stateManagement: ["RxJS", "NgRx", "Context API", "React Hooks"],
    uiDevelopment: ["Reactive Forms", "FormArrays", "Custom Validators", "RBAC"],
    performance: ["SSR/Universal", "Lazy Loading", "OnPush Strategy", "Code Splitting"],
    ...
    authentication: ["MSAL Login", "Google OAuth", "JWT"],
    tools: ["Git", "npm/yarn", "Webpack", "REST APIs", "Postman", "Chrome DevTools"]
  },
  experience: [
    {
      ...
      achievements: [
        "Next.js Migration: Led migration of enterprise application from Angular to Next.js, improving Lighthouse performance score from 30 to 80+ (150% increase) through SSR optimization, image optimization, and code splitting.",
        "Complex Forms: Engineered 60+ dynamic forms with nested FormArrays and custom validators for insurance and accreditation platforms, reducing data entry errors by 60%.",
        "RBAC System: Designed comprehensive Role-Based Access Control (RBAC) system managing 5+ user roles (admin, assessor, applicant, viewer), ensuring secure data access.",
        "Component Library: Architected scalable component library with 30+ reusable UI components, custom directives, and pipes, accelerating development by 25%.",
        "Data Visualization: Created interactive dashboards using Chart.js and TanStack Table with global filtering, sorting, pagination, and real-time updates.",
        "API Integration: Implemented secure RESTful API integration with JWT authentication and HTTP interceptors for request/response handling."
      ]
    }
  ],
  projects: [
    {
      ...
      github: "" // Add public repo link here if desired
    },
    {
      name: "Skybound Construction – Corporate Website",
      techStack: ["React.js", "Tailwind CSS", "Animations", "Responsive Design"],
      details: [
    ...
    },
    {
      ...
      details: [
        "Architected accreditation platform using React.js with modern hooks (useState, useEffect, useCallback, useMemo) for optimal performance",
    ...
    },
    {
      ...
      techStack: ["Angular", "TypeScript", "RxJS", "SSR"],
      details: [
    ...
    },
    {
      ...
      techStack: ["Angular", "Chart.js", "Reactive Forms", "Material"],
      details: [
    ...
    },
    {
      ...
      techStack: ["Angular", "RBAC", "Nested Forms", "PrimeNG"],
      details: [
  ...
  achievements: [
    "Performance: Improved Lighthouse scores from 30 to 70+ through SSR, lazy loading, and image optimization",
    "Productivity: Reduced development time by 25-30% through reusable component libraries and standardized patterns",
